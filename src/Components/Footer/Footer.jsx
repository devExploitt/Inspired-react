                ...
                <div className={s.container}>
                    ...
                    <div className={s.development}>
                        <ul className={s.developmentList}>
                            <li className={s.develpmentItem}>
                                Designer:
                                <a className={s.link} href='https://t.me/Mrshallowww'>Anastasia Ilina</a>
                            </li>
                            <li className={s.develpmentItem}>
                                Developer:
                                <a className={s.link} href='https://t.me/UnskillAnimal'>Ivan Romanov</a>
                            </li>
                        </ul>
                    </div>
                </div>
