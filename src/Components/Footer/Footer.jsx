...
export const Footer = () => (
    <Container className={s.container}>
        ...
        <div className={s.social}>
            <div className={cn(s.socialTitle,s.title)}>СВЯЗАТЬСЯ С НАМИ</div>
            <div className={s.socialSubtitle}>Контакты и адреса магазинов</div>
            <div className={s.socialList}>

                <button href="#" className={cn(s.link,s.socialLinkFB)}>
                ...
                <button href="#" className={cn(s.link,s.socialLinkVK)}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={s.contacts}>
            <div className={s.contactsInfo}>
                <div className={s.link}>Inspired@gmail.com</div>
                <div className={cn(s.phone,s.link)}>8 930 490 26 20</div>
            </div>
        </div>
        <div className={s.development}>
            <div className={s.developmentList}>
                <div className={s.developmentSublist}>
                    <div>Designer: Anastasia Ilina</div>
                    <div>Developer:</div>
                </div>
            </div>
        </div>
